...
namespace Ifs.Application.Trnord
{
	...
	/// <summary>
	/// </summary>
    [FndWindowRegistration("TRN_CUSTOMER_ORDER", "TrnCustomerOrder")]
    public partial class tbwCustomerOrderOverview : cTableWindow
    {
        ...
        /// Default Constructor.
        /// </summary>
        public tbwCustomerOrderOverview()
        {
        ...
        /// <returns></returns>
        public new static tbwCustomerOrderOverview FromHandle(SalWindowHandle handle)
        {
            return ((tbwCustomerOrderOverview)SalWindow.FromHandle(handle, typeof(tbwCustomerOrderOverview)));
        }
        #endregion
        ...
        public virtual SalNumber SetWindowTitle()
        {
            ...
            using (new SalContext(this))
            {
                ...
                Sal.SetWindowText(i_hWndFrame, Ifs.Fnd.ApplicationForms.Int.TranslateConstantWithParams(Properties.Resources.TEXT_CustomerOrderOverview, sItems));
            }
        ...
        public new SalNumber UserMethod(SalNumber nWhat, SalString sMethod)
        {
            ...
            using (new SalContext(this))
            {
                if (sMethod == "vieworder")
                {
                    return UM_ViewOrder(nWhat);
                }
                else if (sMethod == "viewInvoice")
                {
        ...
        /// <param name="nWhat"></param>
        /// <returns></returns>
        public virtual SalNumber UM_ViewOrder(SalNumber nWhat)
        {
            #region Local Variables
            SalNumber nRow = 0;
            #endregion
                ...
                switch (nWhat)
                {
                    case Ifs.Fnd.ApplicationForms.Const.METHOD_Inquire:
                        ...
                        if (Sal.TblFindNextRow(i_hWndFrame, ref nRow, Sys.ROW_Selected, 0))
                        {
                            ...
                            {
                                return Sal.SendMsg(i_hWndFrame, Ifs.Fnd.ApplicationForms.Const.PM_DataSourceCreateWindow, Ifs.Fnd.ApplicationForms.Const.METHOD_Inquire, ((SalString)Pal.GetActiveInstanceName("frmCustomerOrderDetail")).ToHandle());
                            }
                        }
                        return 0;

                    case Ifs.Fnd.ApplicationForms.Const.METHOD_Execute:
                        return Ifs.Fnd.ApplicationForms.Int.PostMessage(i_hWndFrame, Ifs.Fnd.ApplicationForms.Const.PM_DataSourceCreateWindow, Ifs.Fnd.ApplicationForms.Const.METHOD_Execute, Pal.GetActiveInstanceName("frmCustomerOrderDetail"));
                }
            }
        ...
        private void menuItem_View_Inquire(object sender, Ifs.Fnd.Windows.Forms.FndCommandInquireEventArgs e)
        {
            ...
            ((FndCommand)sender).Enabled = Sal.SendMsg(i_hWndFrame, Ifs.Fnd.ApplicationForms.Const.PM_UserMethod, Ifs.Fnd.ApplicationForms.Const.METHOD_Inquire, ((SalString)"vieworder").ToHandle());
        }
        ...
        private void menuItem_View_Execute(object sender, Ifs.Fnd.Windows.Forms.FndCommandExecuteEventArgs e)
        {
            ...
            // Place the logic in UserMethod directly in this event handler.
            Ifs.Fnd.ApplicationForms.Int.PostMessage(i_hWndFrame, Ifs.Fnd.ApplicationForms.Const.PM_UserMethod, Ifs.Fnd.ApplicationForms.Const.METHOD_Execute, "vieworder");
        }
