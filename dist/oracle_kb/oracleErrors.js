export const ORACLE_ERROR_KNOWLEDGE_BASE = {
    'ORA-04063': {
        errorCode: 'ORA-04063',
...
export function getOracleErrorDetails(errorCode) {
    const cleanCode = errorCode.trim().toUpperCase();
    return ORACLE_ERROR_KNOWLEDGE_BASE[cleanCode];
}
export function searchOracleErrors(query) {
    const q = query.toLowerCase();
    return Object.values(ORACLE_ERROR_KNOWLEDGE_BASE).filter(err => err.errorCode.toLowerCase().includes(q) ||
