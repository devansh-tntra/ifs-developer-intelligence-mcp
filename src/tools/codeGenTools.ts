import { z } from 'zod';
import {
  MARBLE_ENTITY_TEMPLATE,
  MARBLE_PROJECTION_TEMPLATE,
  MARBLE_CLIENT_TEMPLATE,
  PLSQL_PACKAGE_TEMPLATE
} from '../knowledge/ifsPatterns.js';
...
export const codeGenTools = [
  {
    ...
    execute: async (args: { unitName: string; testType: string }) => {
...
`
  ...
  },
  {
    ...
    execute: async (args: { luName: string; methodName: string; description: string }) => {
      return {
        code: `
-----------------------------------------------------------------------------
...
`
  ...
  },
  {
    ...
    execute: async (args: { luName: string; component: string; tableName: string }) => {
  ...
  },
  {
    ...
    execute: async (args: { cursorName: string; tableName: string; whereClause: string }) => {
      return {
        code: `
...
`
  ...
  },
  {
    ...
    execute: async (args: { tableName: string; triggerName: string }) => {
      return {
        code: `
...
`
  ...
  },
  {
    ...
    execute: async (args: { functionName: string; returnType: string }) => {
      return {
        code: `
...
`
  ...
  },
  {
    ...
    execute: async (args: { viewName: string; tableName: string }) => {
      return {
        code: `
-----------------------------------------------------------------------------
-- View: ${args.viewName}
...
`
  ...
  },
  {
    ...
    execute: async (args: { entityName: string; component: string; tableName: string }) => {
      return {
  ...
  },
  {
    ...
    execute: async (args: { projectionName: string; component: string; entityName: string }) => {
      return {
  ...
  },
  {
    ...
    execute: async (args: { clientName: string; component: string; projectionName: string; entityName: string }) => {
      return {
...
`
  ...
  },
  {
    ...
    execute: async (args: { modelName: string; component: string }) => {
      return {
  ...
  },
  {
    ...
    execute: async (args: { scriptType: string; tableName: string }) => {
      return {
  ...
  },
  {
    ...
    execute: async (args: { lovName: string; entityName: string }) => {
      return {
        code: `
...
`
  ...
  },
  {
    ...
    execute: async (args: { fieldName: string; dataType: string }) => {
      return {
        customFieldConfig: {
  ...
  },
  {
    ...
    execute: async (args: { actionName: string; projectionName: string }) => {
      return {
  ...
  },
  {
    ...
    execute: async (args: { commandName: string }) => {
      return {
        code: `
...
`
  ...
  },
  {
    ...
    execute: async (args: { projectionName: string; entitySet: string }) => {
      return {
