...
export const docsTools = [
  {
    ...
    execute: async (args: { query: string; version?: string }) => {
  ...
  },
  {
    ...
    execute: async (args: { concept: string; fromVersion: string; toVersion: string }) => {
  ...
  },
  {
    ...
    execute: async (args: { keyword: string }) => {
      ...
      const snippets: { title: string; version: string; code: string }[] = [];
