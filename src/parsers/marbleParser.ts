import { MarbleEntity, MarbleProjection, MarbleClient } from '../types/ifs.js';

export function parseMarbleEntity(content: string, filename: string): MarbleEntity {
  ...
  const attributes: MarbleEntity['attributes'] = [];
  ...
  const associations: MarbleEntity['associations'] = [];
...
export function parseMarbleProjection(content: string, filename: string): MarbleProjection {
...
export function parseMarbleClient(content: string, filename: string): MarbleClient {
